...
10.times do
    ...
    User.create(first_name: the_name.split[0], 
        last_name: the_name.split[1], 
        description: Faker::Markdown.emphasis, 
        email: "#{the_name.split.join}@yopmail.com", 
        password: "coolos")
end
...
30.times do
    Event.create(
        start_date: (DateTime.now + rand(100000..200000)), 
...
#         stripe_customer_id: rand(81274681273..812746812732))
# end